...
import ModalShareButtonUser from "broowc/components/Admin/ModalShareButtonUser";
import UserButtonLink from "broowc/components/Admin/UserButtonLink";
import UserHeadline from "broowc/components/Admin/UserHeadline";
import Metadata from "broowc/components/Metadata";
import ModalShareButtonLink from "broowc/components/Modal/ModalShareButtonLink";
import Watermark from "broowc/components/Watermark";
import api from "broowc/config/api";
...
export default function UserWebPage() {
  ...
  const incrementVisitors = (user) => {
    ...
    if (isHaveBeenVisitor == null || dataUserBio.username != username) {
      let dataVisitor = JSON.parse(localStorage.getItem("user_broowc_linker"));
