...
import { getAppearance, getUser, updateDataDoc } from "broowc/utils/helpers";
...
import { storage } from "broowc/config/firebase";
                      ...
                      <div>
                        ...
                        <div className="bg-gray-600 text-white rounded-b-2xl rounded-tr-2xl p-5 shadow-lg shadow-gray-500/100">
                          ...
                          <small className="text-red-500 font-semibold">
                            Changing the Background Color will remove the
                            Background Image!
                          </small>
