...
import { getUser } from "broowc/utils/helpers";
  ...
  const stepsTour = [
    {
      title: "Appearance",
      description:
        "You can change the appearance of your website starting from the profile photo, background image, button color, font color, etc.",
      target: () => refAppearance.current,
    },
    {
      title: "Total Visitors",
      description: "Click to see who visited your website.",
      target: () => refTotalVisitors.current,
    },
    {
      title: "Visit Your Page",
      description: "View the website display by clicking the button above.",
