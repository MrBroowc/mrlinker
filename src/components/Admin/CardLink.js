...
import { updateDataDoc } from "broowc/utils/helpers";
import { useDrag, useDrop } from "react-dnd";
import { ItemTypes, PARAMS } from "broowc/constants/constants";
import ButtonDeleteCard from "./ButtonDeleteCard";
import { GetCountLinkClicks } from "broowc/utils/getCountLinkClicks";
      ...
      <Tooltip
        ...
        title={
          <div className="text-black p-2">
            <span>Some features on this Card :</span>
            <ul>
              <li style={{ listStyle: "inside" }}>Draggable Card</li>
              <li style={{ listStyle: "inside" }}>
                Edit Link Title and Link Url
              </li>
